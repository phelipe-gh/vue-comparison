<template lang='pug'>
 div
  .center
    .details(v-show='active')
      el-row
        el-col
          span  {{ regionSelectedName }}
          .divider-popover.mb-2(style='color: white')
      el-row.flex.mb-2
        el-col(v-for='item in regionSelected' :key='item.initials')
          el-row
            el-col
              | {{ item.initials }}
              br
    ...
    svg#svg-map(version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 450 460' enable-background='new 0 0 450 460' xml:space='preserve')
      g
        a.estado(xlink:href='#tocantins' name='Tocantins' code='17' v-bind:class='data.to' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#bahia' name='Bahia' code='29' v-bind:class='data.ba' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#sergipe' name='Sergipe' code='28' v-bind:class='data.se' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#pernambuco' name='Pernambuco' code='26' v-bind:class='data.pe' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#alagoas' name='Alagoas' code='27' v-bind:class='data.al' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#riograndedonorte' name='Rio Grande do Norte' code='24' v-bind:class='data.rn' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#ceara' name='Ceará' code='23' v-bind:class='data.ce' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#piaui' name='Piauí' code='22' v-bind:class='data.pi' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#maranhao' name='Maranhão' code='21' v-bind:class='data.ma' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#amapa' name='Amapá' code='16' v-bind:class='data.ap' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#para' name='Pará' code='15' v-bind:class='data.pa' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#roraima' name='Roraima' code='14' v-bind:class='data.rr' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#amazonas' name='Amazonas' code='13' v-bind:class='data.am' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#acre' name='Acre' code='12' v-bind:class='data.ac' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#rondonia' name='Rondônia' code='11' v-bind:class='data.ro' @mouseover="mouseOver('north')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#matogrosso' name='Mato Grosso' code='51' v-bind:class='data.mt' @mouseover="mouseOver('midwest')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#mattogrossodosul' name='Mato Grosso do Sul' code='50' v-bind:class='data.ms' @mouseover="mouseOver('midwest')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#goias' name='Goiás' code='52' v-bind:class='data.go' @mouseover="mouseOver('midwest')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#parana' name='Paraná' code='41' v-bind:class='data.pr' @mouseover="mouseOver('south')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#santacatarina' name='Santa Catarina' code='42' v-bind:class='data.sc' @mouseover="mouseOver('south')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#riograndedosul' name='Rio Grande do Sul' code='43' v-bind:class='data.rs' @mouseover="mouseOver('south')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#saopaulo' name='São Paulo' code='35' v-bind:class='data.sp' @mouseover="mouseOver('southeast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#minasgerais' name='Minas Gerais' code='31' v-bind:class='data.mg' @mouseover="mouseOver('southeast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#riodejaneiro' name='Rio de Janeiro' code='33' v-bind:class='data.rj' @mouseover="mouseOver('southeast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#espiritosanto' name='Espírito Santo' code='32' v-bind:class='data.es' @mouseover="mouseOver('southeast')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#distritofederal' name='Distrito Federal' code='53' v-bind:class='data.df' @mouseover="mouseOver('midwest')" @mouseleave='mouseLeave')
        ...
        a.estado(xlink:href='#paraiba' name='Paraíba' code='25' v-bind:class='data.pb' @mouseover="mouseOver('northEast')" @mouseleave='mouseLeave')
...
export default {
  ...
  data() {
    ...
    return {
      regionNames: {
        north: 'Região do Norte 11%',
        midwest: 'Região do Centro Oeste 15%',
        south: 'Região do Sul 25%',
        southeast: 'Região do Sudeste 31%',
        northEast: 'Região do Nordeste 18%',
      },
      regionSelected: [],
      active: false,
      data: {
  ...
  methods: {
    mouseOver(regionHover) {
      ...
      this.regionSelectedName = this.regionNames[regionHover];
      this.regionSelected = this.regions[regionHover];
      this.active = true;
